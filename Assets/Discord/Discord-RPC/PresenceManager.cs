...
namespace DiscordPresence
{
    ...
    public class PresenceManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            presence.details = "https://tritorus.itch.io/fractured";
        }

        void Update()
        {
            DiscordRpc.RunCallbacks();
            if(GameObject.FindGameObjectWithTag("GeneralManager") != null)
            {
                presence.state = "On loop " + GameObject.FindGameObjectWithTag("GeneralManager").GetComponent<GeneralManager>().levelsCompleted;
            }
